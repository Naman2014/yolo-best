...
CFG_MODEL_PATH = os.path.abspath(r"models\last.pt")
...
def loadmodel(device):
    try:
        with open(CFG_MODEL_PATH, 'rb'):
            st.write("Model file exists and is accessible.")
    except FileNotFoundError:
        st.error("Model file not found.")
        return None
    except Exception as e:
        st.error(f"Error accessing the model file: {str(e)}")
        return None
